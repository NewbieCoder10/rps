...
public class Arena {
  ...
  public static class Builder {
    ...
    private byte numBreeeds = DEFAULT_NUM_BREEDS;
    private int arenaSize = DEFAULT_ARENA_SIZE;
    private Random rng;

    public Builder setNumBreeds(byte numBreeeds) {
      this.numBreeeds = numBreeeds;
      return this;
    }
    ...
    public Arena build() {
      return new Arena(numBreeeds, arenaSize, (rng != null) ? rng : new Random());
